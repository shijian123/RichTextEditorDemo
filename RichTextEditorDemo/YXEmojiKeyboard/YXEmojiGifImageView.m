//
//  YXEmojiGifImageView.m
//  RichTextEditorDemo
//
//  Created by zcy on 2020/11/25.
//

#import "YXEmojiGifImageView.h"
#import "YXEmojiGifImage.h"
#import <QuartzCore/QuartzCore.h>

@interface YXEmojiGifImageView ()

@property (nonatomic, strong) YXEmojiGifImage *animatedImage;
...
@implementation YXEmojiGifImageView
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[YXEmojiGifImage class]] && image.images) {
        if([image.images[0] isKindOfClass:UIImage.class])
            [super setImage:image.images[0]];
        else
            [super setImage:nil];
        self.currentFrame = nil;
        self.animatedImage = (YXEmojiGifImage *)image;
...
- (void)setAnimatedImage:(YXEmojiGifImage *)animatedImage
{
