//
//  YXHtmlFontStyleBar.m
//  RichTextEditorDemo
//
//  Created by zcy on 2020/11/19.
//

#import "YXHtmlFontStyleBar.h"
...
@interface YXHtmlFontStyleBar ()<UIScrollViewDelegate>
...
@implementation YXHtmlFontStyleBar
...
- (void)setupViews:(CGRect)frame {
    ...
    self.scroBarView.frame = CGRectMake(0,0, frame.size.width - KWRightButton_Width, YXFontBar_Height);
    
    self.autoScroBtn.frame = CGRectMake(frame.size.width - KWRightButton_Width, 0, KWRightButton_Width, YXFontBar_Height);
...
- (UIButton *)boldItem {
    if (!_boldItem) {
        ...
        [_boldItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _boldItem;
}
...
- (UIButton *)underlineItem {
    if (!_underlineItem) {
        ...
        [_underlineItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)italicItem {
    if (!_italicItem) {
        ...
        [_italicItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _italicItem;
}
...
- (UIButton *)justifyLeftItem {
    if (!_justifyLeftItem) {
       ...
       [_justifyLeftItem setImage:[UIImage imageNamed:@"zuo"] forState:UIControlStateSelected];
        ...
        [_justifyLeftItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)justifyCenterItem {
    if (!_justifyCenterItem) {
        ...
        _justifyCenterItem.orderTag = @"justifyCenter";
                [_justifyCenterItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)justifyRightItem {
    if (!_justifyRightItem) {
        ...
        _justifyRightItem.orderTag = @"justifyRight";
            [_justifyRightItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
...
//         _indentItem.orderTag = @"blockquote";
            [_indentItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _indentItem;
}
...
//        _outdentItem.orderTag = @"blockquote";
        [_outdentItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _outdentItem;
}
...
- (UIButton *)unorderlistItem {
    if (!_unorderlistItem) {
        ...
        _unorderlistItem.orderTag = @"unorderedList";
            [_unorderlistItem addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)heading1Item {
    if (!_heading1Item) {
        ...
        [_heading1Item addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)heading2Item {
    if (!_heading2Item) {
        ...
        [_heading2Item addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
...
- (UIButton *)heading3Item {
    if (!_heading3Item) {
        ...
        [_heading3Item addTarget:self action:@selector(clickButtonMethod:) forControlEvents:UIControlEventTouchUpInside];
    }
